...
class DQN:
    ...
    def save(self,name,step):
        ...
        self.saver.save(self.session, 'DQN_'+name, global_step=step, write_meta_graph=False)

    def load(self,name):
        with tf.Session() as sess:    
            saver = tf.train.import_meta_graph('DQN_'+name+'-1000.meta')
